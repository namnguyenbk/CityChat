...
public class ChatsFragment extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        mConvList = findViewById(R.id.conv_list);
        ...
        FirebaseRecyclerOptions<Conv> options = new FirebaseRecyclerOptions.Builder<Conv>().setQuery(mConvDatabase, Conv.class).build();
        ...
        FirebaseRecyclerAdapter<Conv, ConvViewHolder> firebaseConvAdapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(
            ...
            protected void onBindViewHolder(@NonNull final ConvViewHolder convViewHolder, int position, @NonNull final Conv conv) {
                ...
                mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        convViewHolder.setUserImage(userThumb, ChatsFragment.this);
            ...
            public ConvViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                @SuppressLint("RestrictedApi") View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.users_single, viewGroup, false);
